...
@section('content')
<div class="container">
    <h3><span class="badge badge-success">Compras</span> <span class="badge badge-dark">Martillo</span></h3>
    <br>
    <h3><a class="badge badge-success" href="javascript:void(0)" id="createNewProduct">Registrar compra</a>
        <br>
            ...
            <div class="modal-body">
                <form id="productForm" name="productForm" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label for="name" class="col-sm-4 control-label">Proveedor</label>
                        <div class="col-sm-12">
                            <select class="form-control" name="id_proveedor" id="id_proveedor"></select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="number" class="form-control" id="cantidad" min="1" name="cantidad" placeholder="Cantidad de productos" value="" maxlength="10" required="">
                        </div>
                    </div>
...
<script type="text/javascript">
    $(function() {
        ...
        $('#createNewProduct').click(function() {
            ...
            $('#modelHeading').html("Registrar Compra");
            ...
            $.get('/proveedores',
                function(data) {
                    $("#id_proveedor").empty();
                    $.each(data, function() {
                        $("#id_proveedor").append("<option value=" + this.id + ">" + this.nombre + "</option>");
                    });
