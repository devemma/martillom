...
@section('content')
<div class="container">
    <h3><span class="badge badge-success">Ventas</span> <span class="badge badge-dark">Martillo</span></h3>
    <br>
    <h3><a class="badge badge-success" href="javascript:void(0)" id="createNewProduct">Registrar venta</a>
        <br>
